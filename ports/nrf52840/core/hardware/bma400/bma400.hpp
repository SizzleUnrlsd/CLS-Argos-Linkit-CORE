...
public:
	...
	void set_wakeup_threshold(double threshold) noexcept;
	void set_wakeup_duration(double duration) noexcept;
	void set_wakeup_gforce(unsigned int g_force) noexcept;
	void set_power_mode(unsigned int power_mode) noexcept;

	void set_x_calibration(double x) noexcept;
	void set_y_calibration(double y) noexcept;
	void set_z_calibration(double z) noexcept;

	[[nodiscard]] double get_x_calibration(void) const noexcept;
	[[nodiscard]] double get_y_calibration(void) const noexcept;
	[[nodiscard]] double get_z_calibration(void) const noexcept;
	[[nodiscard]] uint8_t get_power_mode(void) const noexcept;
	[[nodiscard]] uint8_t get_gforce(void) const noexcept;
